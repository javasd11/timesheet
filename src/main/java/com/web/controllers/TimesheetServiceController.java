...
public class TimesheetServiceController {
    ...
    /**
     * Shows menu of timesheet service: that contains busiest task and employees
     * and managers to look for their assigned tasks.
     *
    ...
    public String showMenu(Model model) {
        ...
        model.addAttribute("employees", employeDao.list());
    ...
    protected void initBinder(WebDataBinder binder) {
        binder.registerCustomEditor(Employee.class, new EmployeeEditor(employeDao));
    ...
    public String showEmployeeTask(@PathVariable("id") long id, Model model){
        Employee employee = employeDao.find(id);
