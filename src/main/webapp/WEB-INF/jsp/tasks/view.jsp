    ...
    <div id="list">
        <ul>
            <li>
                ...
                <input name="description" id="description" value="${task.description}" disabled="${task.completed ? "disabled" : ""}" />
            </li>
            <li>
                <label for="manager">Manager:</label>
                <input name="manager" id="manager" value="${task.manager.name}" disabled="true" />
            </li>
            <li>
                ...
                <table id="employees" class="task-table">
                    <c:forEach items="${task.assignedEmployees}" var="emp">
                        <tr>
                            <sf:form action="${task.id}/employees/del${emp.id}" method="post">
                                <td>
            ...
            <li>
                ...
                <table id="unassigned" class="task-table">
                    <tr>
                        <sf:form method="post" id="add-form">
                            <td>
